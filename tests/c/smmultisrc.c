...
// Test case extracted from the lua source that showed that stackmaps need to
// track multiple locations for the same value or deoptimisation won't work.
...
int lua_geti(void *L, int x, int y) {
  ...
  int f = 6;
  if (y == 1) {
    fprintf(stderr, "geti2: %d %d %d %d %d %d\n", a, b, c, d, e, f);
  } else {
