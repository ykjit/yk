...
//     --- Begin jit-pre-opt ---
//     ...
//     %{{_}}: i{{size}} = call @{{__yk_unopt_:add_uintptr_t}}(%{{_}}, 2i{{size}}) <idem_const 39i{{size}}>
//     ...
//     %{{_}}: i32 = call @{{__yk_unopt_:add_uint32_t}}(%{{_}}, 3i32) <idem_const 41i32>
//     ...
//     %{{_}}: i64 = call @{{__yk_unopt_:add_uint64_t}}(%{{_}}, 4i64) <idem_const 43i64>
//     ...
//     %{{_}}: i{{size}} = call @{{__yk_unopt_:add_uintptr_t}}(%{{_}}, 2i{{size}}) <idem_const 39i{{size}}>
//     ...
//     %{{_}}: i32 = call @{{__yk_unopt_:add_uint32_t}}(%{{_}}, 3i32) <idem_const 41i32>
