...
--   stderr:
--     h1
--     yk-tracing: start-tracing: sidetrace_to_loop.lua:2: GTI
--     yk-tracing: stop-tracing: sidetrace_to_loop.lua:2: GTI
--     --- Begin debugstrs: sidetrace_to_loop.lua:2: GTI ---
--     ; {
--     ;   "trid": "0",
--     ;   "start": {
--     ;     "kind": "ControlPoint"
...
--     ;   }
--     ; }
--     sidetrace_to_loop.lua:2: GTI
--     sidetrace_to_loop.lua:3: TEST
--     sidetrace_to_loop.lua:3: JMP
--     sidetrace_to_loop.lua:12: ADDI
...
--     yk-tracing: start-tracing: sidetrace_to_loop.lua:7: FORLOOP
--     yk-tracing: stop-tracing: sidetrace_to_loop.lua:7: FORLOOP
--     --- Begin debugstrs: sidetrace_to_loop.lua:7: FORLOOP ---
--     ; {
--     ;   "trid": "2",
--     ;   "start": {
--     ;     "kind": "ControlPoint"
...
--     ;   }
--     ; }
--     sidetrace_to_loop.lua:7: FORLOOP
--     --- End debugstrs ---
--     --- Begin debugstrs: sidetrace_to_loop.lua:2: GTI ---
--     ; {
--     ;   "trid": "1",
